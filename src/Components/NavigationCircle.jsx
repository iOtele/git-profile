...
const NavigationCircle = ({ section }) => {
  return (
    <div className="h-[300px] w-[1px] bg-red-500 dark:bg-yellow-500 absolute left-10 hidden md:flex flex-col justify-between items-center transition-colors duration-500">
      <div

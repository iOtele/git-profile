...
import { skillCards } from "../assets/data";
...
const Services = () => {
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-light mb-32 xl:mt-0 mt-12">What I do...</h2>
      <div className="w-full xl:w-[900px] lg:w-[750px] md:w-[500px] grid lg:grid-cols-3 grid-cols-1 lg:gap-12 gap-32 xl:mb-0  ">
        {skillCards.map((card, index) => (
          ...
          >
            <div className="p-2 bg-gray-200 dark:bg-gray-800 transition-colors duration-500">
              <i
            ...
            <div
             ...
             ${hoverCardIndex === index ? getHoverPositionClass(card) : ""}`}
            >
